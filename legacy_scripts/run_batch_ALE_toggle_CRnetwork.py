...
# Specify one or multiple of the following
# 'Rosamond', 'Oklahoma', 'Alaska'
# Default is to loop through all
cr_networks = []
if cr_networks == []:
    cr_networks = ['Rosamond', 'Oklahoma', 'Alaska']
...
burstId_df = burstId_df[burstId_df['cr_network'].isin(cr_networks)]
